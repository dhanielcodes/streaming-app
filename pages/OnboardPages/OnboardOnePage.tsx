...
export default function OnboardOnePage(): JSX.Element {
    const navigation = useNavigation()

    return (
        <ImageBackground blurRadius={4} source={require('../../assets/images/onboard1.png')} resizeMode="cover" style={{ flex: 1, paddingTop: 40 }}>
            <View style={{ flex: 1 }}>
                <View style={{ paddingLeft: 20, paddingRight: 20, flex: 1 }}>
                    <Logo width={phoneWidth * 2.1 / 20} height={phoneHeight * 2.1 / 20} />
                </View>
                <View style={{ padding: 20 }}>
                    <AppText style={{ fontSize: phoneWidth * 0.18 / 2, fontFamily: 'Inter-Bold' }}>Grab all events now only in your hands</AppText>
                    ...
                    <AppButton onPress={() => {
                        navigation.navigate({ name: 'OnboardTwo' })
                    }}>Next</AppButton>
                </View>
            </View>
        </ImageBackground>
